...
import com.humming.asc.sales.component.DateUtils;
...
public class MonthDateView extends View {
    ...
    private int mSelectBGColor = Color.parseColor("#fb8300");
    ...
    private int mCircleColor = Color.parseColor("#fb8300");
    private List<Integer> daysHasThingList;
    private List<Integer> currentThingList;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int day = 0; day < mMonthDays; day++) {
            ...
            if (dayString.equals(mSelDay + "")) {
                ...
                int circleX = (startRecX + endRecX) / 2;
                int circleY = (startRecY + endRecY) / 2;
                int radius = ((endRecX - startRecX) + (endRecY - startRecY)) / 5;
            ...
            if (curLocal.equals(Locale.SIMPLIFIED_CHINESE)) {
                ...
                if (tv_date != null) {
                    ...
                    tv_date.setText(monthEn + " " + mSelYear + ",");
                }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(upX - downX) < 10 && Math.abs(upY - downY) < 10) {//点击事件
                    ...
                    if (downX - upX > 80) {
                        ...
                        //渐变时间
                        aa.setDuration(1000);
                        MonthDateView.this.startAnimation(aa);
                    } else if (upX - downX > 80) {
                        //右滑
                        onLeftClick();
                        AlphaAnimation aa = new AlphaAnimation(0.1f,1.0f);
                        //渐变时间
    ...
    public void onLeftClick() {
        ...
        this.daysHasThingList = null;
        for (int i = 0; i < DCDateList.size(); i++) {
            int selMonth = mSelMonth + 1;
            if (selMonth == DCDateList.get(i).getDateFalg()) {
                this.daysHasThingList = DCDateList.get(i).getDateLists();
            } else {
     ...
     * @param daysList
     */
    public void setDaysHasThingList(List<DailyCallDate> daysList) {
        DCDateList = daysList;
        for (int i = 0; i < DCDateList.size(); i++) {
            int selMonth = mSelMonth + 1;
            if (selMonth == DCDateList.get(i).getDateFalg()) {
                this.daysHasThingList = DCDateList.get(i).getDateLists();
                this.currentThingList = DCDateList.get(i).getDateLists();
            } else {
            }
        }
        //
    ...
    public void setTodayToView() {
        setSelectYearMonth(mCurrYear, mCurrMonth, mCurrDay);
       this.daysHasThingList= this.currentThingList;
        invalidate();
    }
}
