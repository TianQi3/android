...
public class TRMenuAdapter extends RecyclerView.Adapter<TRMenuAdapter.TRMViewHolder> {
    ...
    public TRMenuAdapter(Context context, TopRightMenu topRightMenu, List<MenuItem> menuItemList, boolean show, boolean showDian) {
        this.mContext = context;
        this.mTopRightMenu = topRightMenu;
        this.menuItemList = menuItemList;
        this.showIcon = show;
        this.showDian = showDian;
    }
    ...
    class TRMViewHolder extends RecyclerView.ViewHolder {
        ...
        TRMViewHolder(View itemView) {
            ...
            circleIcon = (ImageView) itemView.findViewById(R.id.trm_menu_item_circle);
        }
    }
