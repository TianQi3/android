...
public class TopRightMenu {
    ...
    private void init() {
        ...
        mAdapter = new TRMenuAdapter(mContext, this, menuItemList, showIcon,showDian);
    }
    ...
    public TopRightMenu showDian(boolean show) {
        this.showDian = show;
        return this;
    }
     ...
     * @return
     */
    public TopRightMenu addMenuItems(MenuItem item) {
    ...
    public TopRightMenu showAtLocation(View anchor, int garey, int xoff, int yoff) {
        if (mPopupWindow == null) {
            getPopupWindow();
        }
        if (!mPopupWindow.isShowing()) {
            mPopupWindow.showAtLocation(anchor, garey, xoff, yoff);
            if (dimBackground) {
