...
public class TaskListActivity extends AbstractActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queryTask(String.valueOf(PageNo));
    }

    //查询Task
    public void queryTask(final String pageNos) {
    ...
    public void queryBykeyWord(final String keyWords, final String pageNos) {
        taskservice.queryByName(new ICallback<TaskListResultVO>() {
            @Override
            public void onDataReady(TaskListResultVO data) {
                currentlist = data.getData();
                int scorllCurrentItem = 0;
    ...
    public void queryByCondition(final String conditionMenu, final String menuValue, final String PageNos) {
        taskservice.queryByCOnditionValue(new ICallback<TaskListResultVO>() {
        ...
        }, conditionMenu, menuValue, PageNos);
    }
        ...
        public TaskListArrayAdapter(Context context, int list_item_customer1, final List<TaskListVO> list, int[] itemPageResArray, int i) {
            ...
            onbtnDailyCallClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    addDailyCallIntent.putExtra(DailyCallEditorActivity.TASK_COME2, "true");
            ...
            onbtnProductClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(TaskProductEditActivity.PRODUCT_COME, "true");
                    intent.putExtra(TaskProductEditActivity.TASK_ID, list.get(position).getTaskId());
