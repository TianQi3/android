...
public class CommentsListActivity extends AbstractActivity {
    ...
    public void queryDailyCall(final String pageNos) {
        dailyCallService.queryComments(new ICallback<DailyCallQueryResultVO>() {
            @Override
            public void onDataReady(DailyCallQueryResultVO result) {
                ...
                getSupportActionBar().setTitle(Application.getInstance().getString(R.string.comments) + "(" + sum + ")");
    ...
    public void QueryByName(final String keywords, final String pageNos) {
        dailyCallService.queryCommentsByName(new ICallback<DailyCallQueryResultVO>() {
    ...
    public void queryByCOndition(final String conditionMenu, final String menuValue, final String pageNos) {
        dailyCallService.queryCommentsByCOnditionValue(new ICallback<DailyCallQueryResultVO>() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.action_daily_call_add).setVisible(false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //add dailyCall
        switch (id) {
            case R.id.action_daily_call_add:
                ...
                break;
            case R.id.action_daily_call_condition:
                Intent intent1 = new Intent(getBaseContext(), DailyCallConditionActivity.class);
