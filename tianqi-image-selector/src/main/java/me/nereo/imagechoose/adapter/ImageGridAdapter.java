...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, Handler handler, boolean showCamera, boolean showTxt) {
        mContext = context;
        mHandler = handler;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == TYPE_CAMERA) {
            ...
            if (holde != null) {
                ...
                if (mode == MultiImageSelectorActivity.MODE_MULTI) {//多选模式
                ...
                } else if (mode == MultiImageSelectorActivity.MODE_CROP) {
                    holde.iv_choose_area.setOnClickListener(new View.OnClickListener() {
                        @Override
